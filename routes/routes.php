...
class routes
{
    public static function getRoutes()
    {
        ...
        $route = new route();
        $route->http_method = 'GET';
        $route->action = 'updateUser';
        $route->page = 'accounts';
        $route->controller = 'accountsController';
        $route->method = 'updateUser';
        $routes[] = $route;


         $route = new route();
        $route->http_method = 'POST';
        $route->action = 'updateAccount';
        $route->page = 'accounts';
        $route->controller = 'accountsController';
        $route->method = 'updateAccount';
        $routes[] = $route;
        //This is an examole of the post for tasks to list tasks.  See the action matches the method name.
        // routes for create, edit, and delete
        ...
        $route = new route();
        $route->http_method = 'GET';
        $route->action = 'getById';
        $route->page = 'tasks';
        $route->controller = 'tasksController';
        $route->method = 'getById';
        $routes[] = $route;
